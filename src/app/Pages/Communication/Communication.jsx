  ...
  return (
    <>
      ...
      <div className="com">
        ...
        <Steps
          progressDot
          current={remarks.length}  // Adjust the current progress dynamically based on remarks length
          direction="vertical"
          items={remarks.map((remark, index) => ({
            title: remark.status,  // Set the status as the title of the step
            description: remark.remark_text,  // Set the remark text as the description
          }))}
        />
        </div>
      </div>
