...
import "./Communication_Workshop.scss";
...
function Communication_Workshop() {
    ...
    useEffect(() => {
      ...
      axios
        .get(`http://127.0.0.1:8000/WorkshopLeads/${id}/`, {
          headers: {
    ...
    const showReminders = () => {
        const reminders = [
          "Follow up with lead on 12/10/2023",
 ...
 : "Loading..."}</h1>
            <div className="com_left_profile_iconCont">
              ...
              <a
  href={
    leadData && leadData.customerNumber
      ? `https://wa.me/91${leadData.customerNumber}`
      : "#"
  }
  target="blank"
>
  <i className="ri-whatsapp-line"></i>
          ...
          <div className="com_left_info">
            ...
            <div className="bind">
              ...
              <h4>{leadData ? leadData.customerEmail : "Loading..."}</h4>
            </div>
            <div className="bind">
            ...
            <div className="bind">
              ...
              <h4>{leadData ? leadData.customerNumber
 : "Loading..."}</h4>
            </div>
            <div className="bind">
              <label htmlFor="course_name">Location</label>
              <h4>{leadData ? leadData.location
 : "Not provided"}</h4>
            </div>
          </div>
        </div>  
...
export default Communication_Workshop