...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='website', max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('enquiry_lead', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='remarks', to='app.enquiry_leads', unique=True)),
                ('workshop_lead', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Workshop_Leads_remarks', to='app.workshop_leads')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_lead', models.ManyToManyField(blank=True, null=True, related_name='assigned_telecaller', to='app.enquiry_leads')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('assigned_workshop_lead', models.ManyToManyField(blank=True, null=True, related_name='workshop_telecaller_leads', to='app.workshop_leads')),
            ],
        ),
        migrations.CreateModel(
